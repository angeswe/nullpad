...
**Prerequisites**: Rust (1.70+), Redis (7.0+)
...
- `ADMIN_PUBKEY` — Ed25519 public key (hex) from tools/keygen.html (required)
...
Rate limiting, session lifetimes, and challenge timeouts are also configurable.
...
**Backend**
- Rust 1.70+ with Axum 0.8 web framework
